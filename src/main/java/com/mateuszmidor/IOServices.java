...
public class IOServices {
	...
	public static InputStream getInputStreamForFile(Path path)
			throws ATtoolException {
		return provider.getInputStreamForFile(path);
	}

	public static OutputStream getOutputStreamForFile(Path path)
			throws ATtoolException {
		return provider.getOutputStreamForFile(path);
	}

	public static InputStream getInputStreamForURI(URI uri)
			throws ATtoolException {
